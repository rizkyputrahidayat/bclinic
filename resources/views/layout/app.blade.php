...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <div class="navbar-brand"><img src="assets/logo/B CLINIC NEW.png" alt="logo" width="230px"
                    height="50px"></div>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="https://bclinicslimming.com/" target="_blank" class="nav-link">
                                <i class="nav-icon fas fa-duotone fa-link"></i>
                                <p>
                                    Lihat Website
                                </p>
                            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ date('Y') }} B Clinic Slimming
