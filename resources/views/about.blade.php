            ...
            <div class="populer-products-content">
                <div class="row">
                        ...
                        <div class="single-populer-products">
                            <div class="single-populer-products">
                                ...
                                <div class="single-populer-products-para">
                                    <p>Setelah selesai treatment, bener-bener muka gw jadi ngerasa glowing banget dan
                                        lembap. So ya ini kali ketiga gw dateng ke B Clinic, and i'am always enjoy my
                                        treatment.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="single-populer-products">
                            <div class="single-populer-product-img mt40">
                                <img src="assets\logo\ANJAS.jpg" alt="logo" width="70%"
                                    style="border-radius: 5% 5% 5% 5%;">
                            </div>
                            <h2><a href="#">Anjasmara</a></h2>
                            <div class="single-populer-products-para">
                                <p>Setelah treatment RF Sineson, perut rasanya anget enak banget karena tujuannya untuk
                                    membakar lemak-lemak di perut. Lalu aku ngelakuin B Magsculpt yang setara dengan sit
                                    ups sebanyak 20.000 kali. Perut rasanya jadi kenceng dan ke toiletnya jadi lancar.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single-populer-products">
                            <div class="single-populer-products">
                                <div class="single-populer-product-img mt40">
                                    <img src="assets\logo\oUwSYEZwLitaGd1testimonial8.png" alt="logo"
                                        width="70%">
                                </div>
                                <h2><a href="#">Harris Illano Vriza</a></h2>
                                <div class="single-populer-products-para">
                                    <p>Problem Mukaku Itu Di Double Chin, Dan Aku Tadi Abis Hifu Treatment. Ngaruh
                                        Banget Buat Muka Aku Langsung Shape Dan Tirus.</p>
                                </div>
                            </div>
                        </div>
                    </div>
