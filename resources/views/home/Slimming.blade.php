                        ...
                        <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
                            <ul class="nav navbar-nav" data-in="fadeInDown" data-out="fadeOutUp">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('p-Story') }}">Story</a></li> <!--belum bisa route-->
                                        <li><a class="dropdown-item" href="{{ route('p-location') }}">location</a></li>
                                    </ul>
                                <li class=""><a href="{{ route('p-career') }}">Careers</a></li> <!--belum bisa route-->
                            </ul>
                            <!--/.nav -->
                        </div><!-- /.navbar-collapse -->
                    </div>
                ...
                <div class="popup" id="popup">
                    <div class="popup_content">
                        ...
                        <div class="popup_header">
                            <h1>B Slimming Advance (Cool Plus 1 Cup)</h1>
                ...
                <div class="popup1" id="popup1">
                    <div class="popup1_content">
                        ...
                        <div class="popup1_header">
                            <h1>B Slimming Advance (Cool Plus 2 Cup)</h1>
                        ...
                        <ul class="menu">
                            <li>
                                <div class="card0">
                                    ...
                                    <a href="#popup">B Slimming Advance <br> (Cool Plus 1 Cup)</a>
                                </div>
                            </li>
                            <li>
                                <div class="card0">
                                    ...
                                    <a href="#popup1">B Slimming Advance <br> (Cool Plus 2 Cup)</a>
                                </div>
                            </li>
                            <li>
                                <div class="card0">
                                    ...
                                    <a href="#popup2">Body Cavitasi + Vacum</a>
                                </div>
                            </li>
                            <li>
                                <div class="card0">
                            ...
                            <li>
                                <div class="card0">
                                    ...
                                    <a href="#popup6">Hair Removal Underarm</a>
                                </div>
                            </li>
                            <li>
                                <div class="card0">
                                    ...
                                    <a href="#popup7">Infuse Whitening</a>
                                </div>
                            </li>
                            <li>
                                <div class="card0">
                            ...
                            <li>
                                <div class="card0">
                                    ...
                                    <a href="#popup9">Resolady 3in 1</a>
                                </div>
                            </li>
                            <li>
                                <div class="card0">
                                    ...
                                    <a href="#popup10">RF Body Slimming</a>
                                </div>
                            </li>
                            <li>
                                <div class="card0">
                            ...
                            <li>
                                <div class="card0">
                                    ...
                                    <a href="#popup12">Slimming Expert</a>
                                </div>
                            </li>
                            <li>
                                <div class="card0">
                                    ...
                                    <a href="#popup13">Vit C Injection</a>
                                </div>
                            </li>
                        </ul>
                    </div>
