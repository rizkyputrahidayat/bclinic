							...
							<div class="popup_content">
								...
								<div class="popup_header">
									...
									<div class="popup_text">
										<font size="2">Merupakan kombinasi treatment <b>Micro Bubble</b> dan <b>Korean Peel</b> yang mampu mengatasi kulit kusam, menurangi kadar minyak pada kulit, membersihkan komedo dan menutrisi kulit wajah.</font><br>
										<font size="2">Sehingga kulit wajah menjadi <b>lebih bersih, sehat</b> dan <b>glowing</b>.</font><br>
									</div>
									<h2></h2>
									<h2></h2>
						...
						<div class="popup1" id="popup1">
							<div class="popup1_content">
								...
								<div class="popup1_header">
									...
									<h2></h2>
									<h2></h2>
									<a href="https://shopee.co.id/bclinic.official?smtt=0.331281872-1672375852.91" class="btn popup1_btn">add to cart</a><br><br>
									<button style="color:red;" onclick="goBack()">Close</button><br><br>
										<script>
											function goBack() {
												window.history.back();
						...
						<div class="popup2" id="popup2">
							<div class="popup2_content">
								...
								<div class="popup2_header">
									...
									<h2></h2>
									<h2></h2>
									<a href="https://shopee.co.id/bclinic.official?smtt=0.331281872-1672375852.92" class="btn popup2_btn">add to cart</a><br><br>
									<button style="color:red;" onclick="goBack()">Close</button><br><br>
										<script>
											function goBack() {
												window.history.back();
						...
						<div class="popup3" id="popup3">
							<div class="popup3_content">
								...
								<div class="popup3_header">
									...
									<h2></h2>
									<h2></h2>
									<a href="https://shopee.co.id/bclinic.official?smtt=0.331281872-1672375852.93" class="btn popup3_btn">add to cart</a><br><br>
									<button style="color:red;" onclick="goBack()">Close</button><br><br>
										<script>
											function goBack() {
												window.history.back();
					...
					<div class="row">
						<div class="col-md-3">
							<div class="single-populer-products">
								<div class="single-populer-product-img ">
									<img src="assets/images/populer-products/COOL PLUS.jpg" alt="populer-products images" style="border-radius: 5% 5% 5% 5%;">
								</div>
						...
						<div class="col-md-3">
							<div class="single-populer-products">
								<div class="single-populer-products">
									<div class="single-populer-product-img">
										<img src="assets/images/populer-products/RF SINESON.jpg" alt="populer-products images" style="border-radius: 5% 5% 5% 5%;">
									</div>
						...
						<div class="col-md-3">
							<div class="single-populer-products">
								<div class="single-populer-product-img ">
									<img src="assets/images/populer-products/B MAGSCULPT.jpg" alt="populer-products images" style="border-radius: 5% 5% 5% 5%;">
								</div>
						...
						<div class="col-md-3">
							<div class="single-populer-products">
								<div class="single-populer-products">
									<div class="single-populer-product-img">
										<img src="assets/images/populer-products/RESOLADY.jpg" alt="populer-products images" style="border-radius: 5% 5% 5% 5%;">
									</div>
