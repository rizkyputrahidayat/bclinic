...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <![endif]-->
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha512-V8hv6igOZrIoZlC5bQ8wvYlLb1l5E6kWJXGpzFhcP0RJgZO6G5l0I/HV7/L6O5nbV8WK6PzvVrJZrP0o0QW8Y1A==" crossorigin="anonymous" />
    </head>
	...
	<body>
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
								...
								<li class="nav-item dropdown">
										...
										<ul class="dropdown-menu">
											<li><a class="dropdown-item" href="p-slimming">Slimmimg & Shaping</a></li> <!--belum bisa route--> 
											<li><a class="dropdown-item" href="{{ route('p-facebody') }}">Face Treatment</a></li>
											<li><a class="dropdown-item" href="{{ route('p-facial') }}">Facial Treatment</a></li>
		...
		<div class="item active">
						<div class="single-slide-item slide1">
							...
							<br><section id="feature" class="feature" style="margin-top: -2%;">
								<div class="container">
									<div class="section-header">
										<div class="col-lg-5">
				...
				<div class="populer-products-content">
					<div class="row">
						<div class="col-md-4">
							<div class="single-populer-products">
								<div class="single-populer-products">
									...
									<img src="assets\logo\testimoni-3.jpg" alt="logo" width="70%">
									</div>
									<h2><a href="#">Amel Carla</a></h2>
									<div class="single-populer-products-para">
										<p>Setelah selesai treatment, bener-bener muka gw jadi ngerasa glowing banget dan lembap. So ya ini kali ketiga gw dateng ke B Clinic, and i'am always enjoy my treatment.</p>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="single-populer-products">
								<div class="single-populer-product-img mt40">
								<img src="assets\logo\ANJAS.jpg" alt="logo" width="70%" style="border-radius: 5% 5% 5% 5%;">
								</div>
								<h2><a href="#">Anjasmara</a></h2>
								<div class="single-populer-products-para">
									<p>Setelah treatment RF Sineson, perut rasanya anget enak banget karena tujuannya untuk membakar lemak-lemak di perut. Lalu aku ngelakuin B Magsculpt yang setara dengan sit ups sebanyak 20.000 kali. Perut rasanya jadi kenceng dan ke toiletnya jadi lancar.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="single-populer-products">
								<div class="single-populer-products">
									<div class="single-populer-product-img mt40">
									<img src="assets\logo\oUwSYEZwLitaGd1testimonial8.png" alt="logo" width="70%">
									</div>
									<h2><a href="#">Harris Illano Vriza</a></h2>
									<div class="single-populer-products-para">
										<p>Problem Mukaku Itu Di Double Chin, Dan Aku Tadi Abis Hifu Treatment. Ngaruh Banget Buat Muka Aku Langsung Shape Dan Tirus.</p>
									</div>
								</div>
							</div>
						</div>
