				...
				<!-- Features Section Begin -->
                    ...
                    <div class="features-ads">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<h1 style="color: #CEAB17; padding-bottom: 20px;"><b>Blog</b> </h1>          
								</div>
							</div>
						</div>
					</div> 
						...
						<div class="col-md-5">
							<div class="single-populer-products">
								<div class="single-populer-product-img">
									<img src="assets/images/populer-products/uswwIKkMDYsahila-hisyam_43.jpeg" alt="populer-products images" class="gmbr">
									<style>
										.gmbr{
											width: 300px;
    										height: 200px;
								...
								<h2><a href="#popup2">Click me</a></h2>
						...
						<div class="popup2" id="popup2">
							<div class="popup2_content">
								...
								<div class="popup2_header">
									...
									<h2>Manfaat Perawatan Hair Growth Berteknologi 3in1 untuk Mencegah-Mengatasi Rambut Rontok</h2><br>
										<p>Apa penyebab kerontokan dini pada rambut? Di antaranya adalah kerusakan folikel rambut, gaya hidup yang kurang baik, asupan nutrisi yang kurang, serta usia. B Clinic menciptakan rangkaian perawatan terbaru dan satu-satu nya di Indonesia, yaitu HAIR GROWTH TREATMENT yang menggabungkan 3 metode untuk mencegah dan merawat rambut dari kerontokan yang terdiri dari:
									3 Metode Hair Growth Treatment, Yaitu : PRP (Platelet-Rich-Plasma),  RF SINESON AQUA INJECTOR.
									Manfaat dari treatment Hair Growth yaitu menangani masalah kerontokan pada rambut,membuat rambut lebih sehat, membuat pertumbuhan alami rambut lebih tebal,meregenerasi sel pertumbuhan baru pada rambut dan juga menutrisi kulit kepala. Dan tidak ada batasan usia bagi siapapun yang ingin melakukan perawatan ini.
									#Hairgrowth #Hairloss #PRP #Hairbeauty</p>
									</div><p>
									<div><br>
									</div>
